...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "Covert", targetNamespace = "http://ws/", className = "proxy.Covert")
    @ResponseWrapper(localName = "CovertResponse", targetNamespace = "http://ws/", className = "proxy.CovertResponse")
    @Action(input = "http://ws/BanqueService/CovertRequest", output = "http://ws/BanqueService/CovertResponse")
