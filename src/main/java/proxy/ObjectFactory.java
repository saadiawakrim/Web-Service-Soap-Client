...
public class ObjectFactory {
    ...
    private final static QName _Covert_QNAME = new QName("http://ws/", "Covert");
    private final static QName _CovertResponse_QNAME = new QName("http://ws/", "CovertResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "Covert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "CovertResponse")
